...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-white/50 dark:bg-white/5 p-1 text-muted-foreground backdrop-blur-sm border border-white/40 dark:border-white/10 shadow-inner",
      className
    )}
    {...props}
  />
