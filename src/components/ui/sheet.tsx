...
>(({ side = "right", className, children, ...props }, ref) => {
  const sideClasses = {
    right: "inset-y-0 right-0 h-full w-3/4 max-w-md data-[state=open]:slide-in-from-right data-[state=closed]:slide-out-to-right",
    left: "inset-y-0 left-0 h-full w-3/4 max-w-md data-[state=open]:slide-in-from-left data-[state=closed]:slide-out-to-left",
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 gap-4 glass border shadow-2xl duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
          sideClasses[side],
          className
        )}
        {...props}
